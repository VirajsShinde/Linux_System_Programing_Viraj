//==================================================================================================================
//
// 11-5- Program which creates 2 threads by using pthread API, 
//       where one thread count no of capital characters from 
//       demo.txt file and other thread count no of small character
//       from same file.
//
// Viraj_Shinde 
//
